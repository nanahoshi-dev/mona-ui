...
import { File, FolderOpen, HeartIcon, Info, LucideAngularModule, Save, View } from "lucide-angular";
import {
    MenubarComponent,
            ...
            code: `
                <mona-menu [text]="'View'">
                    <ng-template monaMenuIconTemplate>
                        <lucide-angular [name]="viewIcon" [size]="14" class="mr-0.5"></lucide-angular>
                    </ng-template>
                </mona-menu>
            `,
            description: `
            ...
            code: `
                <mona-menu-item label="About">
                    <ng-template monaMenuItemIconTemplate let-item>
                        <lucide-angular [name]="infoIcon" [size]="12"></lucide-angular>
                    </ng-template>
                </mona-menu-item>
            `,
            description: `
        ...
        topLevelMenuItemIconTemplate: {
            code: `
                <mona-menubar>
                    <ng-template monaMenuItemIconTemplate let-item>
                        @if (item.label === "Open") {
                            <lucide-angular [name]="openIcon" [size]="12"></lucide-angular>
                        }
                    </ng-template>
                </mona-menubar>
            `,
            ...
            code: `
                <mona-menubar>
                    <ng-template monaMenuIconTemplate let-menu let-items="items">
                        @if (menu === "File") {
                            <lucide-angular [name]="fileIcon" [size]="14" class="mr-0.5"></lucide-angular>
                        }
                    </ng-template>
                </mona-menubar>
            `,
            ...
            <mona-menubar
                ...
                <mona-menu [text]="'File'">
                    ...
                    <mona-menu-item label="Save">
                        ...
                        <ng-template monaMenuItemIconTemplate let-item>
                            <lucide-angular [name]="saveIcon" [size]="12"></lucide-angular>
                        </ng-template>
                    </mona-menu-item>
                ...
                <mona-menu [text]="'Help'">
                    ...
                    <mona-menu-item label="Donate">
                        <ng-template monaMenuItemIconTemplate let-item>
                            <lucide-angular [name]="heartIcon" [size]="12" class="text-pink-600"></lucide-angular>
                        </ng-template>
                    </mona-menu-item>
                </mona-menu>
...
class MenubarWrapperComponent implements ComponentInputsAsSignal<MenubarComponent> {
    ...
    protected readonly viewIcon = View;
