...
- **Declarative Angular 22 Composition**: Compose `<mona-line-series>`, `<mona-area-series>`, `<mona-bar-series>`, `<mona-range-bar-series>`, `<mona-range-area-series>`, `<mona-scatter-series>`, `<mona-bubble-series>`, `<mona-pie-series>`, `<mona-donut-series>`, `<mona-radar-series>`, `<mona-polar-series>`, `<mona-chart-x-axis>`, `<mona-chart-y-axis>`, `<mona-chart-angular-axis>`, `<mona-chart-radial-axis>`, `<mona-chart-legend>`, and `<mona-chart-tooltip>`.
- **Cartesian, Sector & Polar Axis Support**: Multi-series line, area, grouped/stacked bar, floating range bar, continuous range area, scatter, and bubble charts alongside full and partial pie/donut charts, multi-metric radar charts with polygon/circular grid rings, and continuous polar charts mapping directional signals across 360 degrees.
