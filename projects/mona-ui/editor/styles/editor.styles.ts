...
export const editorBaseThemeVariants = cva(
    `
        flex flex-col
...
export const editorContainerThemeVariants = cva(
    `
...
export const editorFontColorPreviewThemeVariants = cva(
    `
        w-full flex h-[2px]
    `
);

export const editorFontColorValueThemeVariants = cva(
    `
...
export const editorFontFamilyDropdownListThemeVariants = cva(
    `
        w-[12em]
    `
);

export const editorFontHighlightPreviewThemeVariants = cva(
    `
        w-full flex h-[2px]
    `
);

export const editorFontHighlightValueThemeVariants = cva(
    `
       flex flex-col items-center justify-center
       gap-0.5 ps-1.25 text-sm
    `
...
export const editorFontSizeDropdownListThemeVariants = cva(
    `
        w-[8em]
    `
);

export const editorHeadingsDropdownListThemeVariants = cva(
    `
        w-[14em]
    `
);

export const editorImageInserterActionsThemeVariants = cva(
    `
...
export const editorImageInserterFormThemeVariants = cva(
    `
        flex flex-col gap-1.5 pt-2
    `
);

export const editorImageInserterRowLabelThemeVariants = cva(
    `
        mb-0.5 ps-0.5 text-sm font-semibold
    `
);

export const editorImageInserterRowThemeVariants = cva(
    `
        flex flex-col justify-center px-2
    `
);

export const editorTableCreatorThemeVariants = cva(
    `
        grid grid-cols-8 gap-0.5 p-1
    `
);

export const editorTableCreatorCellThemeVariants = cva(
    `
        flex h-6 w-6
...
export const editorToolbarThemeVariants = cva(
    `
