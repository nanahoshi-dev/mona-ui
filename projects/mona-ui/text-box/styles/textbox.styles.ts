...
export const textBoxThemeVariants = cva(
    `
...
export const inputThemeVariants = cva(
    `
        px-2
        ${themeControlSurfaceClasses} text-foreground
        border border-input-border shadow-(--shadow-control)
...
export type TextBoxVariantProps = VariantProps<typeof textBoxThemeVariants>;

export type TextBoxVariantInput = VariantInputs<TextBoxVariantProps>;

export type InputVariantProps = VariantProps<typeof inputThemeVariants>;
