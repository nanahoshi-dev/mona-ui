...
describe("TreeService", () => {
    ...
    describe("checking", () => {
        it("checks all descendants when a parent is checked", () => {
            ...
            node1
                .children()
                .forEach(child => expect(service.isChecked(child)).toBe(true));
        });
        ...
        it("unchecks all descendants when a checked parent is unchecked", () => {
            ...
            node1
                .children()
                .forEach(child => expect(service.isChecked(child)).toBe(false));
        });
    });
    ...
    describe("disabling", () => {
        it("disables descendants of a disabled node when disableChildren is enabled", () => {
            ...
            node1
                .children()
                .forEach(child => expect(service.isDisabled(child)).toBe(true));
        });
        ...
        it("does not disable descendants when disableChildren is false", () => {
            ...
            node1
                .children()
                .forEach(child => expect(service.isDisabled(child)).toBe(false));
        });
    });
