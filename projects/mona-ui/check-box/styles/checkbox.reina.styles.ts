...
export const reinaCheckboxVariants = cva(`sr-only appearance-none outline-none peer`);

export const reinaCheckmarkVariants = cva(
    `
        ...
        peer-indeterminate:border-primary
...
export const reinaCheckboxContainerLabelVariants = cva(
    `
        w-full h-full
...
export const reinaCheckboxDirectiveVariants = cva(
    `
