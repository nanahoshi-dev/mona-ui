...
const darkError = "oklch(57.7% 0.245 27.325)";
const darkErrorForeground = "oklch(94.3% 0.029 294.588)";

export const monaThemeColors = Object.freeze({
    light: Object.freeze({
        "--color-background": "oklch(1 0 0)",
        "--color-background-dark": "oklch(0.99 0 0)",
        "--color-surface-muted": "oklch(0.99 0 0)",
    ...
    dark: Object.freeze({
        ...
        "--color-surface-muted": "oklch(0.19 0 0)",
        ...
        "--color-error-foreground": darkErrorForeground,
        "--color-error-hover": "oklch(61.7% 0.245 27.325)",
        "--color-error-active": "oklch(53.7% 0.245 27.325)",
        "--color-error-selected": "oklch(71.7% 0.245 27.325)",
        ...
        "--color-destructive": darkError,
        "--color-destructive-foreground": darkErrorForeground,
