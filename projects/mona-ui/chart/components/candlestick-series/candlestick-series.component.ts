...
import { ChartInvalidationReason, type ChartCandlestickSeriesRegistration } from "../../internal/context/chart-registration-context";
...
export class MonaCandlestickSeriesComponent implements OnInit {
