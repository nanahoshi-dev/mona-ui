...
describe("Chart Brush RAF Coalescing Release Gate (GDSB-R2-001)", () => {
    ...
    it("cancels scheduled RAF handle on manual flush and allows subsequent pointermove to schedule a new frame (GDSB-R3-004)", () => {
        const chartEl = fixture.nativeElement.querySelector("canvas") as HTMLCanvasElement;
    ...
    it("coalesces transient interaction retirement into a single paint on first brush frame (GDSB-R3-005)", () => {
        const chartEl = fixture.nativeElement.querySelector("canvas") as HTMLCanvasElement;
