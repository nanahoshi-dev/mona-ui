...
export class MonaDonutSeriesComponent implements OnInit {
    ...
    /**
     * @description Ratio of the inner hole radius relative to the outer radius (0 to 0.95).
     * @default 0.6
     */
    public readonly innerRadiusRatio = input<number>(0.6);
     ...
     * @default "Donut"
     */
    public readonly name = input<string>("Donut");
    ...
    public ngOnInit(): void {
        ...
        const registration: ChartDonutSeriesRegistration = {
