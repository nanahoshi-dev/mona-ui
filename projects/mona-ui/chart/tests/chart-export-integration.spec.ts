...
@Component({
    template: `
        <mona-chart [animation]="false" [data]="data()" style="display: block; width: 600px; height: 400px;">
            <mona-chart-x-axis />
            <mona-chart-y-axis />
...
@Component({
    template: `
        <mona-chart [animation]="false" [data]="data()" style="display: block; width: 500px; height: 500px;">
...
@Component({
    template: `
        <mona-chart [animation]="false" style="display: block; width: 400px; height: 300px;">
...
@Component({
    template: `
        <mona-chart [animation]="false" [data]="data()" style="display: block; width: 500px; height: 400px;">
...
describe("Chart Export Integration Coverage", () => {
    ...
    beforeEach(() => {
        ...
        if (
            ...
            !(SVGGraphicsElement.prototype as unknown as { getBBox?: () => DOMRect }).getBBox
        ) {
            (SVGGraphicsElement.prototype as unknown as { getBBox?: () => DOMRect }).getBBox = (
