...
@Component({
    imports: [ChartComponent, LineSeriesComponent, ChartXAxisComponent, ChartYAxisComponent, ChartBrushComponent],
    template: `
        <mona-chart
            [animation]="false"
            [data]="data()"
            ...
            <mona-chart-brush [activation]="'drag'" [yAxisId]="brushYAxisId()" (brushChange)="onBrushChange($event)" />
        </mona-chart>
    `
})
