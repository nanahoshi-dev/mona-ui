...
import { CandlestickSeriesComponent } from "../components/candlestick-series/candlestick-series.component";
...
@Component({
    imports: [ChartComponent, CandlestickSeriesComponent, ChartXAxisComponent, ChartYAxisComponent],
    template: `
        <mona-chart
            [animation]="false"
            [data]="data()"
...
class FinancialSeriesKeyHostComponent {
    ...
    public readonly data = signal([{ date: "2026-01-01", open: 100, high: 120, low: 90, close: 110 }]);
}
