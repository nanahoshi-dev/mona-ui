...
@Component({
    imports: [ChartComponent, BarSeriesComponent, ChartXAxisComponent, ChartYAxisComponent, ChartBrushComponent],
    template: `
        <mona-chart
            [animation]="false"
            [data]="data()"
            ...
            <mona-chart-brush [activation]="activation()" (brushChange)="onBrushChange($event)" />
        </mona-chart>
    `
})
