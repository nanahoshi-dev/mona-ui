...
describe("Chart Synchronization Nearest Target Resolution and Axis Namespace Regressions", () => {
    ...
    describe("Exact Y Synchronization across Multiple Columns", () => {
    ...
    describe("Secondary Axis Namespace Filtering", () => {
    ...
    describe("Dense Shared Tooltip Semantic Bucket Query", () => {
