...
describe("Chart Synchronization Crosshair Delivery and Proposal Ownership Regressions", () => {
    describe("Crosshair update and clear share one logical delivery channel", () => {
    ...
    describe("Controlled sync viewport proposal transaction ownership", () => {
    ...
    describe("Ordinary candidate vs dense candidate distance comparison and metric awareness", () => {
