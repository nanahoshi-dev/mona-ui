...
describe("SVG Crossfade Release Gate (WP1 & WP6)", () => {
    ...
    describe("SVG-R3-001: Initial / Null-Source Crossfade Across Families", () => {
    ...
    describe("SVG-R3-006: Scoped Gradient & Clip Path Isolation", () => {
