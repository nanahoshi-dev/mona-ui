...
describe("SVG Polar Parity Release Gate (WP3, WP4, WP5)", () => {
    ...
    describe("SVG-R3-004: Polar Series Z-Order Reordering & Series Re-parenting", () => {
    ...
    describe("SVG-R3-003: Solid <-> Gradient Transitions & Stale Fill-Opacity Removal", () => {
