...
describe("Fourth Export Remediation Regressions (R4)", () => {
    // -------------------------------------------------------------------------
    // R4-02.1 / R4-02.2: responsive image reselection must be impossible after freeze
    // -------------------------------------------------------------------------
    describe("R4-02: Responsive image ownership", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-02: Captured byte validation", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-02: Nested SVG data resource policy", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-02: Stylesheet descendant policy", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-04: Fail-closed transform classification", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-05: Inherited PDF font admission", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-03: Full-raster PDF page-fit density", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-06: Template capability contract", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-08: Color normalization contract", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R4-09: Standalone SVG stylesheet policy", () => {
        const svgNs = "http://www.w3.org/2000/svg";
