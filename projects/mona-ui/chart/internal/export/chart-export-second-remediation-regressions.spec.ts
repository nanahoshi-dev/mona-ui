...
describe("Second Export Remediation Regressions (R2-01 to R2-14)", () => {
    // -------------------------------------------------------------------------
    // R2-01: PDF Capability Admission
    // -------------------------------------------------------------------------
    describe("R2-01: PDF Capability Admission", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-02: Transform Classification", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-03 & R2-10: Complete Style and Runtime State Freezing", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-04: Deterministic Plane and Document Ordering", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-05: Island Density Scaling", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-06 & R2-12: Concrete Color Normalization", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-07: Standalone SVG Validation", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-08: Contain Geometry Math", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R2-09: Animation Suppression Isolation", () => {
