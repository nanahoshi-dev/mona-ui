...
describe("Fifth Export Remediation Regressions (R5)", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-01: Rasterizer transform preservation", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-02 & R5-03: Exact image payload decode & data URI policy", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-04: URL-bearing visual dependency closure", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-05: Island-local SVG fragment ownership", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-06: Paint-aware pseudo-element classification", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-07: Paint bounds, non-inset shadows, and outlines", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-08: Transformed content-box geometry preservation", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-09: CSS mask and 3D transform rejection", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-10: Shadow DOM rejection", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-13: SVG validator exact data URI parsing", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R5-14: Deterministic compositor clip IDs", () => {
