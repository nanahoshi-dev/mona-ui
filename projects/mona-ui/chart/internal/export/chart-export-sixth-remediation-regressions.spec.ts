...
describe("Sixth Export Remediation Regressions (R6)", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-01: generic resource dependency closure", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-02: fragment isolation before staging", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-04: active SVG timing surfaces", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-06: aggregate raster transaction budget", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-07: final SVG embedded payload validation", () => {
    ...
    // -------------------------------------------------------------------------
    describe("R6-06: structural safety boundaries", () => {
