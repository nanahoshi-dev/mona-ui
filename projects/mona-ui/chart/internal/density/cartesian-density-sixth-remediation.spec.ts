...
describe("Cartesian Density Sixth Remediation Suite", () => {
    describe("WP0-A / SD6-R01: Canonical Stack X Coordinate Resolution", () => {
    ...
    describe("WP0-B / SD6-R02: Canonical Stack Identity Index Reverse Lookup", () => {
    ...
    describe("WP0-C / SD6-R03: Stack Group Policy Conservative Threshold Combination", () => {
    ...
    describe("WP0-D / SD6-R04: Hard Cap maxPoints Trigger Below Threshold", () => {
    ...
    describe("WP0-E / SD6-R05: Runtime Retention maxPoints Sensitivity", () => {
    ...
    describe("WP0-F / SD6-R06: Marker Geometry Authority", () => {
    ...
    describe("WP0-G / SD6-R07: Marker Halo Overflow Representative Fallback", () => {
    ...
    describe("WP0-H / SD6-R08: Segment-Aware LTTB when connectNulls = false", () => {
    ...
    describe("WP0-I / SD6-R09: Range Viewport Continuity Neighbors", () => {
    ...
    describe("WP0-J / SD6-R10: Tight Cap Candidate Selection Prioritizing Visible Defined Mark", () => {
    ...
    describe("WP0-K / SD6-R11: Sparse Stack Member Candidate Preservation", () => {
    ...
    describe("WP0-L / SD6-R12: Stack Vertical Segment Interaction Geometry", () => {
    ...
    describe("WP0-Q / SD6-R16: Stacked Formatter Parity", () => {
