...
describe("Cartesian Density Third Remediation (WP0 / SD3-R05 - SD3-R34)", () => {
    describe("SD3-R05: Connected duplicate-X nearest is exact", () => {
    ...
    describe("SD3-R13: Connected dense hit preserves original source X value type", () => {
    ...
    describe("SD3-R14 & SD3-R15: Range raw nearest and brush indexed performance", () => {
    ...
    describe("SD3-R20 & SD3-R23: Stack group isolation and source index contract", () => {
    ...
    describe("SD3-R06: Spatial nearest uses screen-pixel metric", () => {
    ...
    describe("SD3-R07 & SD3-R28: Spatial countInWindow and downsampling budget", () => {
    ...
    describe("SD3-R08 & SD3-R09: Unified marker datum resolution", () => {
    ...
    describe("SD3-R11 & SD3-R12: Typed dense selection mark identity", () => {
    ...
    describe("SD3-R21 & SD3-R22: Stack downsampling policy aggregation and sample indices", () => {
