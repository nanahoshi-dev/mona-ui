...
describe("Cartesian Density Fifth Remediation (SD5-R01 - SD5-R32)", () => {
    describe("WP1: Unified Mark Identity Authority (SD5-R01 - SD5-R05)", () => {
    ...
    describe("WP2 & WP9: Marker Spatial Index Data Validity & Order (SD5-R06 - SD5-R10, SD5-R29 - SD5-R32)", () => {
    ...
    describe("WP3 & WP5: Stack Timeline Dates & Percentage Precision (SD5-R11 - SD5-R13, SD5-R17 - SD5-R20)", () => {
    ...
    describe("WP4: Marker Provider Secondary Distance Tie-Breaking (SD5-R14 - SD5-R16)", () => {
    ...
    describe("WP6: Segment-Aware Boundary Anchoring for connectNulls (SD5-R21 - SD5-R23)", () => {
    ...
    describe("WP7: Strict Point Capping (SD5-R24 - SD5-R26)", () => {
    ...
    describe("WP8: Gap-Safe LTTB Downsampling (SD5-R27 - SD5-R28)", () => {
