...
describe("Cartesian Density Seventh Remediation Suite", () => {
    describe("WP0-A / SD7-R01: Exact Line Crossing Viewport with Zero In-Window Points", () => {
    ...
    describe("WP0-B / SD7-R02: Exact Range Crossing Viewport with Zero In-Window Points", () => {
    ...
    describe("WP0-C / SD7-R03: Exact Hard Cap Evaluated Post-Continuity", () => {
    ...
    describe("WP0-F / SD7-R06: Bounded Explicit LTTB Candidate Stream", () => {
    ...
    describe("WP0-G & WP0-H / SD7-R07: Capacity-Aware Symmetric Segment Budget Allocation", () => {
    ...
    describe("WP0-I & WP0-J / SD7-R08, SD7-R09: Fragmented MinMax and Range Segment Interval Index", () => {
    ...
    describe("WP0-K / SD7-R10: Automatic Global Reducer Budget", () => {
    ...
    describe("WP0-L & WP0-M / SD7-R11, SD7-R12: Retained Stack Member Sparse Indexing & Coverage-Aware Selection", () => {
    ...
    describe("WP0-P / SD7-R15: Stack Formatter Backward Compatibility", () => {
    ...
    describe("WP0-Q & WP0-R / SD7-R17, SD7-R18: Stack and Range Point Radius Parity", () => {
