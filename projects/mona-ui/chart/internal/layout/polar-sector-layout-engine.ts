...
export interface PolarSectorLayoutOptions {
    containerHeight: number;
    containerWidth: number;
    measurements?: ReadonlyMap<string, ChartLabelMeasurement>;
    rootData: readonly unknown[];
    series: readonly ChartSectorSeriesRegistration[];
    styleResolver: ChartStyleResolver;
}

export class PolarSectorLayoutEngine {
    public static computeScene(options: PolarSectorLayoutOptions): PolarSectorChartScene {
        ...
        const polarSeriesScene: ChartSectorSeriesScene = {
            center,
            cornerRadius,
            fillMode,
            formattedTotal,
