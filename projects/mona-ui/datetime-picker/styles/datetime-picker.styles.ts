...
export const dateTimePickerBaseThemeVariants = cva(
    `
        flex items-center
...
export const dateTimePickerHeaderThemeVariants = cva(
    `
...
export const dateTimePickerFooterThemeVariants = cva(
    `
...
type DateTimePickerBaseVariantProps = VariantProps<typeof dateTimePickerBaseThemeVariants>;

type DateTimePickerBaseVariantInput = VariantInputs<DateTimePickerBaseVariantProps>;

type DateTimePickerHeaderVariantProps = VariantProps<typeof dateTimePickerHeaderThemeVariants>;

type DateTimePickerHeaderVariantInput = VariantInputs<DateTimePickerHeaderVariantProps>;

type DateTimePickerFooterVariantProps = VariantProps<typeof dateTimePickerFooterThemeVariants>;
