...
const defaultButtonStrategy = createThemeStrategy<ButtonVariantsFunction>(
    { mona: monaButtonVariants, reina: reinaButtonVariants },
    monaButtonVariants
);
...
export function createButtonStyleStrategy(overrides: readonly ButtonStyleOverrides[] = []): ButtonStyleStrategy {
    ...
    return createThemeStrategy<ButtonVariantsFunction>({ mona, reina }, mona);
}
